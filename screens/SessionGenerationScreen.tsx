            ...
            <ScrollView style={styles.scrollView}>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.card}>
                        ...
                        <View style={styles.infoRow}>
                            <MaterialCommunityIcons name="clock-time-two-outline" size={20} color={classColor} />
                ...
                <View style={styles.section}>
                    <TouchableOpacity
                        style={[styles.actionButton, { backgroundColor: classColor }]}
                ...
                {/* Note d'information */}
                <View style={[styles.infoBox, { backgroundColor: `${classColor}15` }]}>
                    <MaterialCommunityIcons name="information" size={20} color={classColor} />
                    <Text style={[styles.infoBoxText, { color: classColor }]}>
